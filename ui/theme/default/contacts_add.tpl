                    ...
                    <form class="form-horizontal" id="rform">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                {if isset($config['contact_extra_name'])}

                                    <div class="form-group"><label class="col-md-4 control-label" for="account">{$config['contact_extra_name']} </label>
                                ...
                                {if isset($config['contact_has_code'])}
