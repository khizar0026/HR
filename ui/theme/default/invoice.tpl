                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-sm-4'>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="invoicenum" name="invoicenum" {if $invoice}value="{$invoice->invoicenum}" {/if}>
                                        </div>

                                        <div class="form-group">
                                            <label for="cn">{$_L['Invoice']} #</label>

                                            <input type="text" class="form-control" id="cn" name="cn" {if $invoice}value="{$invoice->cn}" {/if}>
