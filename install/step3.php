        ...
        <form action="" method="post" id="ib_form">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="purchase_key" name="purchase_key" value="B5VE-SNP4-KB15-1179-7948">
                    <span class='help-block'><a href="#">POSTED BY GANNJAPARKER</a> </span>
                </div>
